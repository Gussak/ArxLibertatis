...
static int view_player(SaveBlock & save, const char * dat, size_t size) {
	...
	if(asp.Attribute_Redistribute_TotalEarn) std::cout << "Total earn attribute points: " << asp.Attribute_Redistribute_TotalEarn << '\n';
	if(asp.Skill_Redistribute) std::cout << "Available skill points: " << asp.Skill_Redistribute << '\n';
	if(asp.Skill_Redistribute_TotalEarn) std::cout << "Total earn skill points: " << asp.Skill_Redistribute_TotalEarn << '\n';
